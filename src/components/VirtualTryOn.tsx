          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative w-full max-w-md">
              ...
              <div className="w-full aspect-[4/5] rounded-3xl overflow-hidden bg-gray-100 relative">
                <img 
                  src="/lovable-uploads/2e7470d5-25c9-45f2-bf2b-4494746669ed.png" 
                ...
                <div className="absolute top-8 right-8 w-56 h-[480px] bg-black rounded-3xl shadow-2xl overflow-hidden p-1">
                  ...
                  <div className="w-full h-full bg-white rounded-[22px] overflow-hidden relative">
                    ...
                    <div className="px-4 flex-1">
                      <div className="relative bg-gray-50 rounded-2xl overflow-hidden" style={{ height: '320px' }}>
                        {/* Contenedor de la imagen dividida */}
                        <div className="relative w-full h-full">
                          {/* Imagen del lado izquierdo (outfit original) */}
                          <div 
                            className="absolute top-0 left-0 h-full bg-gray-200 overflow-hidden"
                          ...
                          <div 
                            className="absolute top-0 right-0 h-full bg-gray-300 overflow-hidden"
                            style={{ width: `${100 - sliderValue[0]}%` }}
                          >
                            <img 
                              src="/lovable-uploads/62b5a92b-467e-4f7f-96dd-ac35ccc8b9cd.png"
                              alt="Outfit modificado"
                              className="w-full h-full object-cover"
                              style={{ 
                                width: '220px',
                                position: 'absolute',
