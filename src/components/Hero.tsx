  ...
  return <section className="min-h-screen flex flex-col relative overflow-hidden" style={{
    background: 'linear-gradient(135deg, #715391 0%, #CDB2DF 100%)'
      ...
      <div className="lg:hidden container mx-auto px-6 text-center relative z-10 flex-1 flex flex-col justify-center py-8">
        ...
        {/* Subtítulo */}
        <div className={`mb-8 transition-all duration-800 delay-300 ${showElements.subtitle ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
        ...
        {/* Botones de descarga */}
        <div className={`mb-8 transition-all duration-800 delay-1200 ${showElements.buttons ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          <div className="flex flex-col gap-4 max-w-sm mx-auto">
            <a href="https://apps.apple.com/es/app/vesty/id6743717284" target="_blank" rel="noopener noreferrer" className="w-full">
              <Button variant="secondary" size="lg" className="w-full bg-white/20 text-white border border-white/30 hover:bg-white/30 text-lg px-8 py-4 rounded-full font-semibold backdrop-blur-sm">
                Descargar iOS
              </Button>
            </a>
            <a href="#" target="_blank" rel="noopener noreferrer" className="w-full">
              <Button size="lg" className="w-full bg-white text-purple-600 hover:bg-white/90 text-lg px-8 py-4 rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
                Descargar Android
              </Button>
            </a>
          </div>
      ...
      <div className="hidden lg:flex container mx-auto px-8 relative z-10 flex-1 items-center py-8 max-w-7xl">
        ...
        <div className="w-1/2 pr-12">
          ...
          {/* Botones de descarga */}
          <div className={`transition-all duration-800 delay-1200 ${showElements.buttons ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
