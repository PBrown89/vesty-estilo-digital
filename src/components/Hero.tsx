...
const Hero = () => {
  ...
  return <section className="min-h-screen flex items-center justify-center bg-white relative overflow-hidden pt-20 pb-16">
      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center relative z-10 max-w-7xl">
        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            backgroundColor: '#735BF2',
            borderColor: '#735BF2'
          }} className="text-lg px-8 py-4 rounded-full font-semibold transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center gap-3 border-2 bg-white text-[#735bf2]">
