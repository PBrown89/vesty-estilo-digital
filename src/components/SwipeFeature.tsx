          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative">
              ...
              <div className="w-80 h-96 rounded-3xl overflow-hidden bg-gradient-to-br from-orange-100 to-yellow-100 relative flex items-center justify-center">
                ...
                {/* Mockup del teléfono flotante - movido 100px a la izquierda */}
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 -translate-x-[100px] w-48 h-80 bg-white rounded-3xl shadow-2xl overflow-hidden">
