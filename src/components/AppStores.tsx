const AppStores = () => {
  ...
  const storeLogos = [{
    name: "Zara",
    src: "/placeholder-logo-1.png"
  }, {
    name: "H&M",
    src: "/placeholder-logo-2.png"
  }, {
    name: "Nike",
    src: "/placeholder-logo-3.png"
  }, {
    name: "Adidas",
    src: "/placeholder-logo-4.png"
  }, {
    name: "Mango",
    src: "/placeholder-logo-5.png"
  }, {
    name: "Uniqlo",
    src: "/placeholder-logo-6.png"
  }, {
    name: "COS",
    src: "/placeholder-logo-7.png"
  }, {
    name: "Massimo Dutti",
    src: "/placeholder-logo-8.png"
  }];
  return <section className="bg-white py-[120px]">
